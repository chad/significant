...
- "headline": 6–12 words, neutral newsroom register, no clickbait, no hashtags, no emoji. Each item carries diffuse (bool) and story_coherence (0–1, fraction of posts sharing a companion term). If diffuse=false, the burst is one story: name the actual event plainly and confidently. If diffuse=true, the posts span unrelated stories — you MUST NOT pick the most newsworthy subplot and present it as the story (that is lying with a headline); instead say mentions are elevated and name the largest thread, e.g. "Mentions of X are elevated; largest thread concerns Y".
